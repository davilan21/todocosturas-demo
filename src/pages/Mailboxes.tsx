...
export default function Mailboxes() {
  ...
  return (
    <>
      ...
      >
        <p className="text-sm text-slate-600">Elegí el proveedor. Solo pedimos permiso de <strong>lectura</strong> de correo; no podemos enviar, mover ni borrar mensajes.</p>
